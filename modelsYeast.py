...
def train_model(model, train_loader, val_loader=None, epochs=50, lr=0.01, modelname=""):
    ...
    # Save the weights
    torch.save(model.state_dict(), "results/" + modelname + "_protein_model_Yeast.pth")
    print("Model saved!")
#3. Prediction Script
...
df_pos_A_AC = pd.read_csv('Data/YeastDu/P_Protein_A_AC.csv')
df_pos_A_AC = df_pos_A_AC.drop(df_pos_A_AC.columns[0], axis=1)
df_pos_B_AC = pd.read_csv('Data/YeastDu/P_Protein_B_AC.csv')
df_pos_B_AC = df_pos_B_AC.drop(df_pos_B_AC.columns[0], axis=1)
df_pos_A_ACC = pd.read_csv('Data/YeastDu/P_Protein_A_ACC.csv')
df_pos_A_ACC = df_pos_A_ACC.drop(df_pos_A_ACC.columns[0], axis=1)
df_pos_B_ACC = pd.read_csv('Data/YeastDu/P_Protein_B_ACC.csv')
df_pos_B_ACC = df_pos_B_ACC.drop(df_pos_B_ACC.columns[0], axis=1)
df_pos_A_conjoint = pd.read_csv('Data/YeastDu/P_Protein_A_conjoint.csv')
df_pos_A_conjoint = df_pos_A_conjoint.drop(df_pos_A_conjoint.columns[0], axis=1)
df_pos_B_conjoint = pd.read_csv('Data/YeastDu/P_Protein_B_conjoint.csv')
...
df_neg_A_AC = pd.read_csv('Data/YeastDu/N_Protein_A_AC.csv')
df_neg_A_AC =  df_neg_A_AC.drop( df_neg_A_AC.columns[0], axis=1)
df_neg_B_AC = pd.read_csv('Data/YeastDu/N_Protein_B_AC.csv')
df_neg_B_AC =  df_neg_B_AC.drop( df_neg_B_AC.columns[0], axis=1)
df_neg_A_ACC = pd.read_csv('Data/YeastDu/N_Protein_A_ACC.csv')
df_neg_A_ACC =  df_neg_A_ACC.drop( df_neg_A_ACC.columns[0], axis=1)
df_neg_B_ACC = pd.read_csv('Data/YeastDu/N_Protein_B_ACC.csv')
df_neg_B_ACC =  df_neg_B_ACC.drop( df_neg_B_ACC.columns[0], axis=1)
df_neg_A_conjoint = pd.read_csv('Data/YeastDu/N_Protein_A_conjoint.csv')
df_neg_A_conjoint =  df_neg_A_conjoint.drop( df_neg_A_conjoint.columns[0], axis=1)
df_neg_B_conjoint = pd.read_csv('Data/YeastDu/N_Protein_B_conjoint.csv')
...
for seedrandom in range(10):
    ...
    y_score = predict(model, X1_test, X2_test, "results/seed-" + str(seedrandom) + "_protein_model_Yeast.pth")
    ...
    acc1 = accuracy_score(y_test, y_score, sample_weight=None)
    spec1 = (cm1[0, 0]) / (cm1[0, 0] + cm1[0, 1])
    sens1 = recall_score(y_test, y_score, sample_weight=None)
    prec1 = precision_score(y_test, y_score, sample_weight=None)
...
with open('results/result_Yeast.txt', 'w') as f:
    f.write(resultStr)
print(resultStr)
print("Hello World")